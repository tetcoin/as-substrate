(module
  ...
  (func $test_data_in (type 26) (param i32 i32) (result i64)
    ...
    i32.const 8
    i32.add
    call $<tetcoin_scale_codec::compact::Compact<u32>_as_tetcoin_scale_codec::codec::Decode>::decode::h08366d89ea61a2f4
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
            ...
            block  ;; label = @5
              ...
              i32.const 8
              i32.add
              call $<tetcoin_scale_codec::compact::Compact<T>_as_tetcoin_scale_codec::codec::Encode>::encode_to::h122d0706bc7fa667
              block  ;; label = @6
                block  ;; label = @7
                  local.get 2
                  i32.load offset=12
    ...
    call $alloc::raw_vec::capacity_overflow::h6059d871cf90f853
    unreachable)
  (func $<tetcoin_scale_codec::compact::Compact<u32>_as_tetcoin_scale_codec::codec::Decode>::decode::h08366d89ea61a2f4 (type 21) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 1
  ...
  (func $<sp_runtime_interface::pass_by::Codec<T>_as_sp_runtime_interface::pass_by::PassByImpl<T>>::from_ffi_value::h95ca68abfebcbf5b (type 27) (param i32 i64)
    ...
    call $core::option::expect_none_failed::h7674c343b6d036bd
    unreachable)
  (func $<tetcoin_scale_codec::compact::Compact<T>_as_tetcoin_scale_codec::codec::Encode>::encode_to::h122d0706bc7fa667 (type 21) (param i32 i32)
    (local i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
        ...
        block  ;; label = @3
          block  ;; label = @4
            block  ;; label = @5
              ...
              i32.const 16
              i32.add
              call $sp_core::sandbox::_::<impl_tetcoin_scale_codec::codec::Encode_for_sp_core::sandbox::EnvironmentDefinition>::encode::h65527a6654accd30
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    block  ;; label = @9
                ...
                block  ;; label = @7
                  ...
                  loop  ;; label = @8
                    ...
                    i32.const 80
                    i32.add
                    call $sp_wasm_interface::_::<impl_tetcoin_scale_codec::codec::Encode_for_sp_wasm_interface::Value>::encode_to::h3b5d2ce8e2864d50
                    local.get 8
                    i32.const 16
                    i32.add
                    local.set 8
                  ...
                  block  ;; label = @8
                    block  ;; label = @9
                      ...
                      block  ;; label = @10
                        ...
                        i32.const 72
                        i32.add
                        call $sp_wasm_interface::_::<impl_tetcoin_scale_codec::codec::Decode_for_sp_wasm_interface::Value>::decode::h51fd6c436dad6250
                        local.get 5
                        i32.load offset=80
                        local.tee 3
                        i32.const 4
  ...
  (func $sc_runtime_test::execute_sandboxed::env_inc_counter::h9d52bff70609f350 (type 2) (param i32 i32 i32 i32)
    ...
    i32.const 5
    i32.store)
  (func $sp_core::sandbox::_::<impl_tetcoin_scale_codec::codec::Encode_for_sp_core::sandbox::EnvironmentDefinition>::encode::h65527a6654accd30 (type 21) (param i32 i32)
  ...
  (func $sp_sandbox::imp::dispatch_thunk::heb8666fcd53dc40e (type 28) (param i32 i32 i32 i32) (result i64)
    ...
    i32.const 8
    i32.add
    call $<alloc::vec::Vec<T>_as_tetcoin_scale_codec::codec::Decode>::decode::h47f34604b47b427f
    block  ;; label = @1
      local.get 4
      i32.load offset=24
      local.tee 1
      ...
      i32.const 24
      i32.add
      call $tetcoin_scale_codec::codec::Encode::encode::hd3718da052421b8b
      local.get 4
      i64.load32_u offset=8
      i64.const 32
      i64.shl
  ...
  (func $<alloc::vec::Vec<T>_as_core::clone::Clone>::clone::h101d5679f2ee4644 (type 21) (param i32 i32)
    ...
    unreachable
    unreachable)
  (func $sp_wasm_interface::_::<impl_tetcoin_scale_codec::codec::Encode_for_sp_wasm_interface::Value>::encode_to::h3b5d2ce8e2864d50 (type 21) (param i32 i32)
    ...
    call $alloc::raw_vec::capacity_overflow::h6059d871cf90f853
    unreachable)
  (func $sp_wasm_interface::_::<impl_tetcoin_scale_codec::codec::Decode_for_sp_wasm_interface::Value>::decode::h51fd6c436dad6250 (type 21) (param i32 i32)
    (local i32 i32 i32 i32 i64)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
  ...
  (func $<&T_as_core::fmt::Debug>::fmt::h1435b9692c8a3aa4 (type 1) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 3)
  (func $tetcoin_scale_codec::codec::Encode::encode::hd3718da052421b8b (type 21) (param i32 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $<&T_as_core::fmt::Debug>::fmt::h9d04952e95d791be (type 1) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 4)
  (func $<alloc::vec::Vec<T>_as_tetcoin_scale_codec::codec::Decode>::decode::h47f34604b47b427f (type 21) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get 0
    i32.const 64
    i32.sub
